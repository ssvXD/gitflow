...
walls = [
    ...
    pygame.Rect(110, 300, 100, 20),
    pygame.Rect(170, 410, 100, 20),
    pygame.Rect(330, 380, 100, 20),
    pygame.Rect(490, 410, 100, 20),
    pygame.Rect(550, 510, 100, 20)
]
...
fire2 = FireSprite(fire_sheet, 9, 1, 215, 110)  # Огонь 2 опущен между стенами
fire3 = FireSprite(fire_sheet, 9, 1, 280, 230)  # Огонь 3 опущен между стенами
fire4 = FireSprite(fire_sheet, 9, 1, 440, 230)
...
def level_5(screen):
    ...
    while running:
        ...
        offset4 = (fire4.rect.x - dragon.rect.x, fire4.rect.y - dragon.rect.y)
        if dragon.mask.overlap(fire.mask, offset) or dragon.mask.overlap(fire2.mask, offset2) or dragon.mask.overlap(fire3.mask, offset3) or dragon.mask.overlap(fire4.mask, offset4):
